...
namespace EPA2.EPAappraisal
{
    public partial class BPAInfoPage1 : System.Web.UI.Page
    {
        ...
        private void AssemblingPageTitle()
        {
            ...
            AppraisalData.BuildingTextTitle(ref labelTitle61, "Title", User.Identity.Name, category, area, code + "61");
            AppraisalData.BuildingTextTitle(ref labelTitle62, "Title", User.Identity.Name, category, area, code + "62");
