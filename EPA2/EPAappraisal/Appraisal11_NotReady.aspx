<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appraisal11_NotReady.aspx.cs" Inherits="EPA2.EPAappraisal.Appraisal11_NotReady" %>
        ...
        <div style="height: 650px;">
            <div style="display: inline; width: 100%; float: left; border: 1px solid lightsalmon; margin: -1px">
                ...
                <div class="ContentMessage">
                    ...
                    <asp:Label ID="labelMessage" runat="server" CssClass="labelMessage">Selected Teacher's Profile is not ready for appraisal!!! Please check the User Appraisal Profile </asp:Label>
