        ...
        <section>
            <div class="ContentTitle">
                <div id="ContentTitleLeft" class="ContentTitleLeft">
                    ...
                    <img class="imgChat" runat="server"  id="imgAGP" src="../images/help.png" title="Help Workflow"  />
            ...
            <div class="ContentTextarea">
                ...
                <table style="border-collapse: collapse; border-spacing: 0; border: 1px">
                    <tr>
                        ...
                        <th>
                            <asp:Label ID="labelTitle3" runat="server" CssClass="labelTitle2">Text Box Title</asp:Label>
                            <br />
                    ...
                    <tr>
                        <td style="vertical-align: top; border-bottom: 1px solid grey">
                            <asp:Label ID="labelListTitle" runat="server" CssClass="labelTitle">Text Box Title</asp:Label><br />
                            <asp:CheckBoxList ID="CblResources" runat="server" Width="200px" OnSelectedIndexChanged="CblResources_SelectedIndexChanged">
                                <asp:ListItem>ListItem1</asp:ListItem>
                                <asp:ListItem>ListItem2</asp:ListItem>
                                <asp:ListItem>ListItem3</asp:ListItem>
                                <asp:ListItem>ListItem4</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td>
