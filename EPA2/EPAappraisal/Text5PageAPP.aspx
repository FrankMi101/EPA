        ...
        <section>
            <div class="ContentTitle">
                <div id="ContentTitleLeft" class="ContentTitleLeft">
                    ...
                    <img class="imgChat" src="../images/help.png" title="Help Workflow" id="APP" />
                    ...
                    <div style="overflow: scroll; width: 99.5%; height: 100%" id="DivMainContent">
                        <asp:GridView ID="GridView1" runat="server" CellPadding="0" Height="100%" Width="99%" GridLines="Both" AutoGenerateColumns="False" BackColor="White" BorderColor="gray" BorderStyle="Ridge" BorderWidth="1px" CellSpacing="0" EmptyDataText="No Appraisal Staff in current search condition" EmptyDataRowStyle-CssClass="emptyData" ShowHeaderWhenEmpty="true">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PRINCIPAL’S/VICE-PRINCIPAL’S GOALS">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editTextGoals" runat="server" Text='<%# Eval("Goals") %>' CssClass="Goals, textAreaEdit" Width="100%" TextMode="MultiLine">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="STRATEGIES/ACTIONS">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editTextStrategyAction" runat="server" Text='<%# Eval("StrategyAction") %>' CssClass="StrategyAction, textAreaEdit" Width="100%" TextMode="MultiLine">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="LEADERSHIP PRACTICES AND COMPETENCIES">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="METHODS AND INDICATORS">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="RESULTS">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editTextResults" runat="server" Text='<%# Eval("Results") %>' CssClass="Results, textAreaEdit" Width="100%" TextMode="MultiLine">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<script>
    ...
    function getTitleTips(xTitle) {
        var rVal = "";
        switch (xTitle) {
            case "PRINCIPAL’S/VICE-PRINCIPAL’S GOALS":
                rVal = "(Identified in consultation with immediate supervisor)";
                break;
            case "LEADERSHIP PRACTICES AND COMPETENCIES":
                rVal = "(What key leadership practices and competencies will assist you in achieving your goals?)";
                break;
            case "METHODS AND INDICATORS":
                rVal = "(Observable- How will we know of the strategies/actions were successful?)";
                break;
            case "STRATEGIES/ACTIONS":
                rVal = "STRATEGIES/ACTIONS";
                break;
            case "RESULTS":
                rVal = "(Measurable - include actual #s and %s)";
                break;
            default:
