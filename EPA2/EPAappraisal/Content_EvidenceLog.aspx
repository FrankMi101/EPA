<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Content_EvidenceLog.aspx.cs" Inherits="EPA2.EPAappraisal.Content_EvidenceLog" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Horizontal_Tab" style="margin-left: -2px;">
            <asp:Button ID="Appraiser" runat="server" Text="Appraiser" CssClass="TabClassH btnTab" OnClick="Appraiser_Click" />
            <asp:Button ID="Appraisee" runat="server" Text="Appraisee" CssClass="TabClassH btnTab" OnClick="Appraisee_Click" />   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <%--   <ul>
