...
//     var helptext = EPA2.Models.WebService1.GetHelpContent("Read", UserID, CategoryID, AreaID, ItemCode, "Help", onSuccessHelp, onFailure);
...
//    // ItemCode = $(this)[0].id.replace("img_", "");
//    var helptext = EPA2.Models.WebService1.GetHelpContent("Read", UserID, CategoryID, AreaID, ItemCode, "EP", onSuccessHelp, onFailure);
