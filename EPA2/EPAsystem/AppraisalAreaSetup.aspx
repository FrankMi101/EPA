<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraisalAreaSetup.aspx.cs" Inherits="EPA2.EPAsystem.AppraisalAreaSetup" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <section>
            ...
            <asp:Button ID="btnAddNew" runat="server" Text="Add New Appraisal Area" OnClick="btnAddNew_Click" />
        ...
        $('td > .mySave').click(function (event) {
            try {
                if ($("#hfContentChange").val() == "1") {
                    ...
                    var result = EPA2.Models.WebService.SaveAppraisalArea(saveObj, onSuccessUpdate, onFailureUpdate);
        ...
        $('td > .myAction').click(function (event) {
            try {
                ...
                if (result) {
                    ...
                    var result2 = EPA2.Models.WebService.SaveAppraisalArea(saveObj, onSuccessDel, onFailureDel);
