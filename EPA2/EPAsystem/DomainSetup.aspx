<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DomainSetup.aspx.cs" Inherits="EPA2.EPAsystem.DomainSetup" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CellPadding="1" Height="100%" Width="100%" GridLines="Both" AutoGenerateColumns="False" BackColor="White" BorderColor="gray" BorderStyle="Ridge" BorderWidth="1px" CellSpacing="1" EmptyDataText="No domain items" EmptyDataRowStyle-CssClass="emptyData" ShowHeaderWhenEmpty="true">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Domain ID">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="editCode" runat="server" Text='<%# Eval("DomainID") %>' CssClass="myCode" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Domain Name">
                                    <ItemStyle Width="30%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editText" runat="server" Text='<%# Eval("DomainName") %>' CssClass="myName" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<script>
    ...
    $(document).ready(function () {
        ...
        //    $("#hfContentChange").val("1");
        //});
        //$('td > .myName').change(function (event) {
        //    $("#hfContentChange").val("1");
        //});
        //$('td > .myCode').change(function (event) {
        //    $("#hfContentChange").val("1");
        //});
        //$('td > .myUserRole').change(function (event) {
        //    $("#hfContentChange").val("1");
