<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationUsersMultipleSchools.aspx.cs" Inherits="EPA2.EPAsystem.ApplicationUsersMultipleSchools" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <section>
                    ...
                    <div style="overflow: scroll; width: 100%; height: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                        <asp:GridView ID="GridView1" runat="server" CellPadding="1" Height="100%" Width="100%" GridLines="Both" AutoGenerateColumns="False" BackColor="White" BorderColor="gray" BorderStyle="Ridge" BorderWidth="1px" CellSpacing="1" EmptyDataText="No Appraisal Staff in current search condition" EmptyDataRowStyle-CssClass="emptyData" ShowHeaderWhenEmpty="true">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Principal/VP">
                                    <ItemStyle Width="20%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editCode" runat="server" Text='<%# Eval("UserName") %>' CssClass="myUser" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="School">
                                    <ItemStyle Width="50%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editText" runat="server" Text='<%# Eval("SchoolName") %>' CssClass="mySchool" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="UserID" HeaderText="" ItemStyle-CssClass="myUserID">
                                    <ItemStyle Width="0px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SchoolCode" HeaderText="" ItemStyle-CssClass="mySchoolCode">
                                    <ItemStyle Width="0px" />
                                </asp:BoundField>
                            </Columns>
            ...
            <asp:Button ID="btnAddNew" runat="server" Text="Add New User work for Multiple School" OnClick="btnAddNew_Click" />
        ...
        <div id="DDLDIV" class="bubble epahide">
            ...
            <asp:DropDownList ID="ddlSchool" runat="server" Height="25px"></asp:DropDownList>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('td > .myUser').click(function (event) {
        ...
        $("#ddlPrincipal").change(function (event) {
            var selValue = event.target.value;
            var seltext =  $('#ddlPrincipal :selected').text(); 
            eventCell.val(seltext);
            workingCell.text(selValue);
            $("#hfContentChange").val("1");
            $("#DDLDIV").fadeToggle("fast");
        });
        $("#ddlSchool").change(function (event) {
            var selValue = event.target.value;
            var seltext = $('#ddlSchool :selected').text();
            eventCell.val(seltext);
            workingCell.text(selValue);
            $("#hfContentChange").val("1");
            $("#DDLDIV").fadeToggle("fast");
