<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DomainLookFors.aspx.cs" Inherits="EPA2.EPAsystem.DomainLookFors" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <section>
            ...
            <asp:Label ID="labelTitle1" runat="server" CssClass="labelTitleX">Text Box Title</asp:Label><asp:DropDownList ID="ddlDomain" runat="server" Height="23px" AutoPostBack="true" OnSelectedIndexChanged="ddlDomiin_SelectedIndexChanged"></asp:DropDownList>   <br />
            <asp:Label ID="labelTitle2" runat="server" CssClass="labelTitleX">Text Box Title</asp:Label> <asp:DropDownList ID="ddlCompetency" runat="server" Height="23px" AutoPostBack="true" OnSelectedIndexChanged="ddlCompetency_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CellPadding="1" Height="100%" Width="100%" GridLines="Both" AutoGenerateColumns="False" BackColor="White" BorderColor="gray" BorderStyle="Ridge" BorderWidth="1px" CellSpacing="1" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText=" ID">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="editCode" runat="server" Text='<%# Eval("LookForsID") %>' CssClass="myCode" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Lookfors">
                                    <ItemStyle Width="75%" Wrap="True" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editText" runat="server" Text='<%# Eval("LookForsName") %>' CssClass="myName" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <footer>
            ...
            <asp:Button ID="btnAddNew" runat="server" Text="Add New Look Fors " OnClick="btnAddNew_Click" />
