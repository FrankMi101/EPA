<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListItemsSetup.aspx.cs" Inherits="EPA2.EPAsystem.ListItemsSetup" %>
...
<body>
    <form id="form2" runat="server">
      ...
      <section>
            ...
            <div style="display:inline-block; float:left; color:darkcyan;font-size:1.1em;">
          Select Working Category:
              <asp:DropDownList ID="ddlCategory" runat="server" Height="23px" Width="300px"  AutoPostBack="true" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList>
            <asp:Button ID="btnAddNew" runat="server" Text="Add New Item of " OnClick="btnAddNew_Click" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Name">
                                 ...
                                 <asp:TemplateField HeaderText="Steps">
                                    <ItemStyle Width="5%" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editSteps" runat="server" Text='<%# Eval("Orders") %>' CssClass="mySteps" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="KeyPoint">
                                    <ItemStyle Width="5%" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="editPoint" runat="server" Text='<%# Eval("KeyPoint") %>' CssClass="myPoint" Width="100%" Height="100%">  </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        $('td > .mySave').click(function (event) {
            try {
                if ($("#hfContentChange").val() == "1") {
                    ...
                    var keyP = $(this).closest('tr').find('td > .myPoint').val();
