        ...
        private static string GetSPInClass(string action)
        {
            ...
            switch (action)
            {
                ...
                case "NotificationeUserEmail":
                    return "dbo.EPA_Appr_AppraisalProcess_EmailUser" + parameters + "@SchoolYear,@SchoolCode,@EmployeeID,@SessionID,@NoticeType,@NoticeArea,@NoticeRole,@Category";
                case "NotificationeMail":
                    return "dbo.EPA_Appr_AppraisalProcess_Notification" + parameters1;
                case "NotificationeMailSave":
                    return "dbo.EPA_Appr_AppraisalProcess_Notification" + parameters1 + ",@NoticeDate,@NoticeRole,@DeadlineDate,@NoticeSubject,@Comments";
