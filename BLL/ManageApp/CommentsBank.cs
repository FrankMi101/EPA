   ...
   public  class CommentsBank
    {
        ...
        public static List<OLFCategory> OLFCategories(object parameter)
        {
            return CommonList<OLFCategory>("OLFCategories", parameter);
        }
        ...
        public static List<OLFCategory> OLFCategoriesbyPanel(object parameter)
        {
            return CommonList<OLFCategory>("OLFCategoriesbyPanel", parameter);
        }
