...
CREATE proc [dbo].[EPA_Appr_AppraisalProcess_SignOffComplete]  -- 'Appraiser','mif','20172018','0529','00014245','Appraisal1','SUM','Admin'
	@Operate		varchar(30),
	@UserID			varchar(30),
...
select [dbo].[EPA_Appr_CheckSignOffComplete](@SignOffType,@UserID,@SchoolYear,@SchoolCode,@EmployeeID,@SessionID,@ItemCode,@UserRole, @Category )
/*
