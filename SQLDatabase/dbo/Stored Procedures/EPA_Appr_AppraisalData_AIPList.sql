...
CREATE proc [dbo].[EPA_Appr_AppraisalData_AIPList]    -- '0','mif','20172018','0528','00010452','Session1','PPA' 
	@Operate		varchar(30),
	@UserID			varchar(30),
...
if @Value is null
    begin
		...
		select   [SequenceNo],[Criteria],[Concern],[Practices],[Steps],[Indicators],[Completed]
