...
CREATE proc [dbo].[EPA_Appr_AppraisalProcess_NotificationRemindEmail_NTP]
...
begin
	...
	where category ='EPA' and NoticeType ='TPA' and NoticeGo = @ToWho and NoticeFrom ='AppAdmin' and Active ='X' and NoticeFor ='Remind'
	...
	(NoticeAction, School_Year, School_Code, EmployeeID,NoticeType,NoticeDate, DeadlineDate, NoticeSubject,Comments,lu_User,lu_Function, lu_Date)
	values('Reminder', @SchoolYear,@SchoolCode,@EmployeeID,'EPA', getdate(), @DueDate,  @mailSubject,@mailBody,@UserID, app_name(),getdate())
