...
-- ================================================================================== 
--dbo.EPA_Appr_Report_AnnualGrowthPlan  'Report', 'mif','20172018','0529','00012934', 'Appraisal1','PPA'
CREATE procedure [dbo].[EPA_Appr_Report_AnnualGrowthPlan] 
	@Operate		varchar(30),
	@UserID			varchar(30),
...
select A.AreaForGrowth, A.GrowthStrategy,A.TimeLine, A.FutureGrowth , 
...
from  [dbo].[EPA_Appr_Comments_AGP] as A
left join  dbo.EPA_getReportSignatureRate(@SchoolYear, @SchoolCode,@EmployeeID,@SessionID,'AGP95')   as B on A.EmployeeID = B.EmployeeID
where A.School_Year =@SchoolYear and A.School_Code =@SchoolCode and A.EmployeeID =  @EmployeeID and SessionID =@SessionID  and ItemCode ='AGP11'
