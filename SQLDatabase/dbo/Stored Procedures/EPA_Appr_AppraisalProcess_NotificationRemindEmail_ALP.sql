...
CREATE proc [dbo].[EPA_Appr_AppraisalProcess_NotificationRemindEmail_ALP]
...
begin
	...
	where category ='EPA' and NoticeType ='ALP' and NoticeGo = @ToWho and NoticeFrom ='AppAdmin' and Active ='X' and NoticeFor ='Remind'
