CREATE TABLE [dbo].[EPA_sys_EmailNotificationTemplate_Personal] (
    ...
    CONSTRAINT [PK_EPA_sys_EmailNotificationTemplate_Personal] PRIMARY KEY CLUSTERED ([UserID] ASC, [Category] ASC, [NoticeFor] ASC, [NoticeType] ASC, [NoticeApprArea] ASC, [NoticeGo] ASC, [NoticeFrom] ASC)
);
