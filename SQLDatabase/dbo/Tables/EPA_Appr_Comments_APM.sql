CREATE TABLE [dbo].[EPA_Appr_Comments_APM] (
    ...
    CONSTRAINT [PK_EPA_Appr_Comments_APM] PRIMARY KEY CLUSTERED ([School_Year] ASC, [School_Code] ASC, [SessionID] ASC, [EmployeeID] ASC, [ItemCode] ASC)
);
