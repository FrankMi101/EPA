CREATE TABLE [dbo].[EPA_Appr_Rating] (
    ...
    CONSTRAINT [PK_EPA_Appr_Rating] PRIMARY KEY CLUSTERED ([School_Year] ASC, [School_Code] ASC, [EmployeeID] ASC, [SessionID] ASC, [ItemCode] ASC, [Category] ASC)
);
