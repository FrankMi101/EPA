...
namespace EPA2.Generic.LIB
{
    public class EducatorsList : IListRepository<Educator2, string>
    {
        ...
        public IList<Educator2> GetListItems(string userRole, string userID, string schoolyear, string schoolcode, string searchby, string searchValue)
        {
            ...
            DataTable dt = StaffList.AppraisalStaff(userRole, userID, schoolyear, schoolcode, searchby, searchValue).Tables[0];
            ...
            foreach (DataRow row in dt.Rows)
            {
                mylist.Add(new Educator2()
                {
                    ...
                    AppraisalProcess = row["AppraisalProcess"].ToString(),
