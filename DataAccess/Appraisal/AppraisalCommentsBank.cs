...
namespace DataAccess
{
    public class AppraisalComments
    {
        ...
        private static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string panel)
        {
        ...
        private static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string panel,string domain)
        {
        ...
        private static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string panel, string domain,string competency)
        {
        ...
        private static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string panel, string domain, string competency, string lookfor)
        {
        ...
        private static void SetupBaseParameters(ref MyADO.MyParameterDB[] myPara, string operate, string userID, string panel, string domain, string competency, string lookfor,string tipsId)
        {
